namespace TheChaddening.Items.Dumbbells
{
    ...
    {
        public LeechingLift() : base("Leeching Lift Dumbbell", 
            "After witnessing the Brain of Cthulhu' brain power, you were inspired to craft a dumbbell out of its carcass.", 
